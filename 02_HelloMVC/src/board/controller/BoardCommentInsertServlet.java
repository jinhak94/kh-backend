...
public class BoardCommentInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BoardComment bc = 
				new BoardComment(0, boardCommentLevel, boardCommentWriter, boardCommentContent, boardRef, boardCommentRef, null);
		...
		//3. 메세지 session 속성 저장 및 리다이렉트 처리

		String location = request.getContextPath() + "/board/boardView?boardNo=" + boardRef;
